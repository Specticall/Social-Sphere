...
export const db = {
  AAA01: {
    ...
    friends: ["AAA05", "AAA03", "AAA04"],
    friendRequest: ["AAA07", "AAA09"],
    outgoingRequest: ["AAA08"],
    blocked: ["AAA10"],
    isOnline: Math.random() > 0.5,
    chatId: "CCC01",
  },
  ...
  AAA03: {
    ...
    friends: ["AAA01", "AAA09", "AAA04"],
    friendRequest: [],
    outgoingRequest: ["AAA02"],
    blocked: [],
    isOnline: Math.random() > 0.5,
    chatId: "CCC01",
  },
  ...
  AAA06: {
    ...
    friends: ["AAA02", "AAA07", "AAA08"],
    friendRequest: [],
    outgoingRequest: ["AAA05"],
    blocked: [],
    isOnline: Math.random() > 0.5,
    chatId: "CCC01",
  },
  ...
  AAA09: {
    ...
    friends: ["AAA03", "AAA05", "AAA07"],
    friendRequest: [],
    outgoingRequest: ["AAA01", "AAA04"],
    blocked: [],
    isOnline: Math.random() > 0.5,
    chatId: "CCC01",
  },
